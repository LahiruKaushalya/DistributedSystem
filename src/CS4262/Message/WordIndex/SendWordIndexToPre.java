 ...
 */
public class SendWordIndexToPre implements IMessage, IInitializerWordIndex{
    ...
    length SEND_WI_PRE word_cound file_count word_name file_id_1 file_id_2... file_count word_name file_id_1 file_id_2....
    */
    @Override
    public String createMsg() {
        String msg = " SEND_WI_PRE ";
    ...
    public void handle(StringTokenizer st) {
        ...
        while (wordCount > 0) {
            ...
            while (fileCount > 0) {
                ...
                wordIndexInitializer.updateFromSuc(word, file);
                fileCount--;
            }
            wordCount--;
        }
