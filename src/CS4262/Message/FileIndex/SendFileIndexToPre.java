 ...
 */
public class SendFileIndexToPre implements IMessage, IInitializerFileIndex{
    ...
    length SEND_FI_PRE file_cound file_id_1 ip port file_id_2 ip port ....
    */
    @Override
    public String createMsg() {
        String msg = " SEND_FI_PRE ";
    ...
    public void handle(StringTokenizer st) {
        ...
        while (fileCount > 0) {
            ...
            while (nodeCount > 0) {
                ...
                fileIndexInitializer.updateFromSuc(fileHolder, fileID);
                nodeCount--;
            }
            fileCount--;
        }
